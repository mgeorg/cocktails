...
\begin{document}%
\newcommand{\flashcardfront}[3]{%
\hbox to 4.25in{%
\hskip 0.25in%
\vbox to 2.75in{%
\vskip 0.25in%
\hbox to 3.75in{\small\hss#1}%
\vskip 0.25in%
\hbox to 3.75in{\hfill \mbox{\LARGE #2}\hfill}%
\vss%
\hbox to 3.75in{\hfill \parbox{3.75in}{#3\hfill}\hfill}%
\vss%
\vskip 0.25in%
}%
}%
...
\vbox to 2.75in{%
\vskip 0.25in%
\hbox to 3.75in{\hfill\parbox{3in}{#1\hfill}\hfill}%
\vss%
\hbox to 3.75in{\hfill\parbox{3in}{Garnish: #2\hfill}\hfill}%
\vss%
\hbox to 3.75in{\hfill\parbox{3in}{Instructions: #3\hfill}\hfill}%
\vss%
\hbox to 3.75in{\small\hfill page: #4}%
\vskip 0.25in%
}%
}%
\newcommand{\flashcard}[7]{%
\setbox\boxfront\vbox{\flashcardfront{#1}{#2}{#3}}%
\setbox\boxback\vbox{\flashcardback{#4}{#5}{#6}{#7}}%
\ifnum\count10 = 0%
